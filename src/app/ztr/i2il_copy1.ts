...
//	const i2il_arr: string[] = ["टडपबसयरलमनफअद","টডপবসযরলমনফঅদ","ਟਡਪਬਸਯਰਲਮਨਫਅਦ",
//		"ટડપબસયરલમનફઅદ","ଟଡପବସଯରଲମନଫଅଦ","டdபbஸயரலமநfஅԃ","టడపబసయరలమనఫఅద",
//		"ಟಡಪಬಸಯರಲಮನಫಅದ","അtడപబసಯరలമನಫద","අටඩපබසයරලමනඵԃ","Aㅌㄸㅍㅂㅅㅑㄹ을ㅁㄴfԃ","AтдпБсйрлмɦфԃ"];
//त_TA		ত_TA	ਤ_TA	ત_TA		ତ_TA	త_TA	ತ_TA		ത_TA	த_TA 	ත_ta
//द_DA		দ_DA		ਦ_DA	દ_DA		ଦ_DA	ద_DA	ದ_DA	ദ_DA					ද_da
//अ_a		অ_a		ਅ_a		અ_a		ଅ_a		అ_a		ಅ_a		അ_a	அ_a	අ_a
//ह_H		হ_H		ਹ_H		હ_H		ହ_H		హ_H		ಹ_HA	ഹ_H		ஹ_H	හ_H
//kKzZtTdDjJqQnpfbBmsSyrlwaɦ
	const i2il_arr: string[] = [
		"कखजझटडपबसयरलमनफअहदत","কটডপবসযরলমনফঅহদত","ਕਟਡਪਬਸਯਰਲਮਨਫਅਹਦਤ",
		"કટડપબસયરલમનફઅહદત","ଟଡପବସଯରଲମନଫଅଦ","కటడపబసయరలమనఫఅదత",
		"ಟಡಪಬಸಯರಲಮನಫಅದತ","tഡപബസയരലമനഫഅദത","கடdபbஸயரலமநfஅԃத",
		"ටඩපබසයරලමනඵඅදත","ㅌ다ㅍ바ㅅy라lㅁㄴfaԃт","тдпБсйрлмɦфaԃт"
	];
...
// अ_a	অ_A	ਅ_A	અ_A	ଅ_A	అ_A	ಅ_A	അ_A	அ_A ട_TTA
	...
	const hinchars: string = "tdpbsyrlmnfaԃт"; 
